package com.mittop.ifree.common;
...
public class Page<T> implements Serializable {
	...
	* @Description: TODO 
	*/ 
	private static final long serialVersionUID = -2141172217674823708L;

	/** 内容 */
	private final List<T> content = new ArrayList<T>();
	
	/** sql内容 */
	private final List<Map<String,Object>> contentSql = (List<Map<String, Object>>) new ArrayList<T>();
	 ...
	 *            分页信息
	 */
	public Page(List<Map<String,Object>> content, long total, Pageable pageable,Boolean sqlflag) {
		this.contentSql.addAll(content);
		this.total = total;
		this.pageable = pageable;
	...
	public List<Map<String, Object>> getContentSql() {
		return contentSql;
	}
